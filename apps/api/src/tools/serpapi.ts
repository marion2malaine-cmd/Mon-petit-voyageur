...
const AIRPORT_CODES: Record<string, string> = {
  ...
  "la nouvelle-orleans": "MSY", "new orleans": "MSY", "nouvelle-orleans": "MSY", "san diego": "SAN",
  houston: "IAH,HOU", dallas: "DFW,DAL", austin: "AUS", "san antonio": "SAT", texas: "DFW,IAH", denver: "DEN",
  colorado: "DEN", honolulu: "HNL", hawai: "HNL", hawaii: "HNL", maui: "OGG", atlanta: "ATL", georgie: "ATL",
  georgia: "ATL", philadelphie: "PHL", philadelphia: "PHL", phoenix: "PHX", arizona: "PHX", nashville: "BNA",
  tennessee: "BNA", memphis: "MEM", "salt lake city": "SLC", utah: "SLC", portland: "PDX", oregon: "PDX",
  nevada: "LAS", louisiane: "MSY", louisiana: "MSY", illinois: "ORD,MDW", massachusetts: "BOS",
  "washington dc": "IAD,DCA", tampa: "TPA", "key west": "EYW", "fort lauderdale": "FLL", charleston: "CHS",
  savannah: "SAV", detroit: "DTW", minneapolis: "MSP", anchorage: "ANC", alaska: "ANC", "etats-unis": "JFK,LAX",
  "united states": "JFK,LAX", usa: "JFK,LAX", montreal: "YUL", quebec: "YQB", toronto: "YYZ",
  vancouver: "YVR", calgary: "YYC", ottawa: "YOW", canada: "YUL,YYZ", mexico: "MEX", "mexico city": "MEX",
  guadalajara: "GDL", oaxaca: "OAX", cancun: "CUN", yucatan: "CUN", "riviera maya": "CUN",
