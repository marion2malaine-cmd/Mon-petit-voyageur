...
- Programme jour par jour : visites gratuites jamais répétées, options d'activités payantes de catégories différentes (culture, sport, découverte, farniente, gastronomie) jugées contre le budget, restaurants réels bien notés (Google Maps, à partir de 4,2 étoiles et 50 avis, 4 étoiles et 20 avis là où l'offre est trop mince ; badge « Note Google Maps vérifiée »), plan B météo, déroulé horaire, conseils pratiques.
