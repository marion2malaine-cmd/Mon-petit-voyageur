export const text = {
  fr: {
    ...
    ctaCardSub: "Laissez notre IA créer le voyage parfait pour vous. Inscription par email ou avec Google, 7 jours d'essai gratuit puis 5,99 €/mois, sans engagement.",
  ...
  en: {
    ...
    ctaCardSub: "Let our AI craft the perfect trip for you. Sign up by email or with Google, 7-day free trial then €5.99/month, no commitment.",
